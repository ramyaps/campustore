...
echo "end delete";
    ...
    public function addToWaitingList($user_id, $product_id) {
	date_default_timezone_set('America/Detroit');
	 global $pdo;
        $query = $pdo->prepare("INSERT INTO waiting_list ( user_id , product_id , add_date ) VALUES ( ? , ? , ? );");
        $query->bindValue(1, (int)$user_id, PDO::PARAM_INT);
        $query->bindValue(2, (int)$product_id, PDO::PARAM_INT);
